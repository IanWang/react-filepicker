...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactFilepicker = __webpack_require__(1);
	
	var _ReactFilepicker2 = _interopRequireDefault(_ReactFilepicker);
	
	var _demo = __webpack_require__(5);
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  var customOptions = {
	    ...
	    buttonClass: _demo2.default.customButton,
	    multiple: true,
	    mimetype: 'image/*',
	    container: 'window',
	    services: ['COMPUTER', 'FACEBOOK', 'CLOUDAPP']
	  ...
	  var callback = function callback(fpfiles) {
	  ...
	  _reactDom2.default.render(_react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_ReactFilepicker2.default, { apikey: apikey })
	    ),
	    _react2.default.createElement(
	      'form',
	      null,
	      ...
	      _react2.default.createElement(_ReactFilepicker2.default, { apikey: apikey, mode: 'dragdrop', options: dragDropOptions, onSuccess: callback })
	    ),
	    _react2.default.createElement(
	      'form',
	      null,
	      ...
	      _react2.default.createElement(_ReactFilepicker2.default, { apikey: apikey, defaultWidget: false, onSuccess: callback })
	    ),
	    _react2.default.createElement(
	      'form',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactFilepicker = function (_Component) {
	  _inherits(ReactFilepicker, _Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    var fp = function() {
	        ...
	        var extendObject = function(name, obj, is_public) {
	            ...
	            if (is_public) {
	                addObjectTo(name, obj, __webpack_provided_window_dot_filepicker);
	            }
	        };
	    ...
	    if (!__webpack_provided_window_dot_filepicker) {
	        __webpack_provided_window_dot_filepicker = fp;
	    } else {
	        for (var attr in fp) {
	            __webpack_provided_window_dot_filepicker[attr] = fp[attr];
	        }
	    }
	})();
	...
	filepicker.extend("urls", function() {
	    ...
	    if (__webpack_provided_window_dot_filepicker.hostname) {
	        base = __webpack_provided_window_dot_filepicker.hostname;
	    }
